...
public class NoiseCreator : EditorWindow
{
	...
	// Material Properties
	static readonly string[] properties2D = new string[] {
		"Normalized",
		"Transparent",
		"Displaced",
		"Colored",
	...
	static readonly string[] properties3D4D = new string[] {
		"Normalized",
		"Transparent",
		"Animated",
		"Displaced",
	...
	void OnGUI ()
	{
		...
		shaderName = EditorGUILayout.TextField ("Name: ", shaderName);
